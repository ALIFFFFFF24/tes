                ...
                <div class="col-lg-8  mb-5 mb-lg-0">
                    <article class="row mb-5">
                        ...
                        <div class="col-12 mx-auto">
                            <h3><a class="post-title" href="{{ url('portofolio/detail') }}">Elements That You Can Use To Create A
                            ...
                            <p>Heading example Here is example of hedings. You can use this heading by following
                                ...
                                italics, with asterisks or underscores.</p> <a href="{{ url('portofolio/detail') }}"
                    ...
                    <article class="row mb-5">
                        ...
                        <div class="col-12 mx-auto">
                            <h3><a class="post-title" href="{{ url('portofolio/detail') }}">Cheerful Loving Couple Bakers
                            ...
                            <p>It’s no secret that the digital industry is booming. From exciting startups to global
                                ...
                                fresh projects is the key to standing out.</p> <a href="{{ url('portofolio/detail') }}"
                                class="btn btn-outline-primary">Continue Reading</a>
                        </div>
                    </article>
                    <article class="row mb-5">
                    ...
                    <article class="row mb-5">
                        ...
                        <div class="col-12 mx-auto">
                            ...
                            <ul class="list-inline post-meta mb-4">
                                ...
                                <li class="list-inline-item">Date : March 14, 2020</li>
                                <li class="list-inline-item">Categories : <a href="#!" class="ml-1">Videography
                                    </a>
                                </li>
                    ...
                    <div class="widget">
                        ...
                        <ul class="list-unstyled widget-list">
                            <li class="media widget-post align-items-center">
                                <a href="{{ url('portofolio/detail') }}">
                                    <img loading="lazy" class="mr-3" src="{{ asset('client/images/post/post-6.jpg') }}">
                                </a>
                                <div class="media-body">
                                    <h5 class="h6 mb-0"><a href="{{ url('portofolio/detail') }}">Elements That You Can Use To
                        ...
                        <ul class="list-unstyled widget-list">
                            <li class="media widget-post align-items-center">
                                <a href="{{ url('portofolio/detail') }}">
                                    <img loading="lazy" class="mr-3" src="{{ asset('client/images/post/post-1.jpg') }}">
                                </a>
                                <div class="media-body">
                                    <h5 class="h6 mb-0"><a href="{{ url('portofolio/detail') }}">Cheerful Loving Couple Bakers
                                            Drinking Coffee</a>
                                    </h5>
                        ...
                        <ul class="list-unstyled widget-list">
                            <li class="media widget-post align-items-center">
                                <a href="post-details-2.html">
                                    <img loading="lazy" class="mr-3" src="{{ asset('client/images/post/post-2.jpg') }}">
                                </a>
                                <div class="media-body">
